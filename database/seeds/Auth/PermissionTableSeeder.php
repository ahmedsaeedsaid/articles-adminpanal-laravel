...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'view-article';
        $viewBackend->display_name = 'view article';
        $viewBackend->sort = 48;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'create-article';
        $viewBackend->display_name = 'Create article';
        $viewBackend->sort = 49;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'edit-article';
        $viewBackend->display_name = 'Edit article';
        $viewBackend->sort = 50;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'delete-article';
        $viewBackend->display_name = 'Delete article';
        $viewBackend->sort = 51;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'view-article-category';
        $viewBackend->display_name = 'View article category';
        $viewBackend->sort = 52;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'create-article-category';
        $viewBackend->display_name = 'Create article category';
        $viewBackend->sort = 53;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'edit-article-category';
        $viewBackend->display_name = 'Edit article category';
        $viewBackend->sort = 53;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
        ...
        $viewBackend = new Permission();
        $viewBackend->name = 'delete-article-category';
        $viewBackend->display_name = 'Delete article category';
        $viewBackend->sort = 54;
        $viewBackend->created_by = 1;
        $viewBackend->updated_by = null;
        $viewBackend->created_at = Carbon::now();
